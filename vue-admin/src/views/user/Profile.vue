    ...
    <el-card style="width:500px;margin-top:20px">
      <el-form :model="form">
        ...
        <el-form-item>
          ...
          <el-button type="warning" @click="$router.push('/user/change-password')">修改密码</el-button>
        </el-form-item>
      </el-form>
    </el-card>
  </div>
...
onMounted(async () => {
  ...
  Object.assign(form, { username: res.data.username, realName: res.data.realName, phone: res.data.phone || '', email: res.data.email || '' })
})
