    ...
    <el-card style="width:500px;margin-top:20px">
      <el-form :model="form">
        ...
        <el-form-item>
          ...
          <el-button type="warning" @click="$router.push('/admin/change-password')">修改密码</el-button>
        </el-form-item>
      </el-form>
    </el-card>
  </div>
...
const save = async () => { await request.put('/admin/profile', { ...form }); ElMessage.success('修改成功') }
</script>
